...
<html>
    ...
    <body>
        ...
        <br><br>
        <a class="link"href="FormProd.php">Registrar</a>
        <br><br><hr>
          ...
          for ($i = $num; $objeto = $res->fetch_object() ; $i++)
          {
            ...
            <table border="1" class="List">
                <tr id="<?= $objeto->id?> ">
                    ...
                    <td>
                        <a href="formEdit_Prd.php?ID=<?=$objeto->id?>"><input class="boton2" type="button" value="editar"/></a>   
                    </td>    
                    <td> 
                        <a href="det_prod.php?ID=<?=$objeto->id?>"><input class="boton2" type="button" value="info completa"/></a>
                    </td>    
                </tr>
            </table>
